/*
* Schrijf een programma dat de BMI (Body Mass Index) van een gebruiker berekent op basis van hun lengte (in meters) en
* gewicht (in kilogrammen).Formule bmi = gewicht / (lengte * lengte) Het programma moet vervolgens bepalen of de gebruiker
*
* ondergewicht, normaal gewicht, overgewicht of obesitas heeft op basis van de BMI-waarden.
